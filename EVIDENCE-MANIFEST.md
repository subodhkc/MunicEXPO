...
Every claim → code → test → live surface → artifact → originality commit.
...
| Consequence-label truth | `data/kestrel-demo/consequence-labels.ts` | audited vs frozen source | report + constellation labels | corrected labels | `ee1cbafb` (2026-09-14) |

## Kestrel frozen facts (verifiable in machine JSON)
